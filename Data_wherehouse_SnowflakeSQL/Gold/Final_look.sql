...
-- See all schemas
SHOW SCHEMAS IN DATABASE TOURISM_DB;

-- See all tables in Bronze
SHOW TABLES IN SCHEMA TOURISM_DB.BRONZE;

-- See all tables in Silver
SHOW TABLES IN SCHEMA TOURISM_DB.SILVER;

-- See all tables in Gold
SHOW TABLES IN SCHEMA TOURISM_DB.GOLD;

-- See all views in Gold
SHOW VIEWS IN SCHEMA TOURISM_DB.GOLD;