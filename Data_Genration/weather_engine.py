...
FIX: Added temperature-based condition override
     so Luxor/Aswan show Sunny/Hot instead of always Clear
"""
...
def get_city_weather(lat, lon):
    ...
    try:
        ...
        # FIX: Override condition based on Egypt temperature
        # So Luxor/Aswan show Sunny or Hot instead of always Clear
        if temp >= 42:
            condition = "Hot"
        elif temp >= 35 and condition == "Clear":
            condition = "Sunny"
        elif temp <= 15:
            condition = "Cold"
